...
namespace WebApplication
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundleContent/Kendo").Include(
                      "~/Scripts/Kendo/2018.2.516/kendo.common-material.min.css",
                      "~/Content/Kendo/2018.2.516/kendo.common.min.css",
                      "~/Content/Kendo/2018.2.516/kendo.silver.min.css"));
        }
    }
}
